      ...
      <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        ...
        <div className="flex flex-col gap-5">
          ...
          <p className="text-sm leading-relaxed" style={{ color: "#5c4a32" }}>
            ...
            bookings and arrangements ourselves. This approach minimizes
            reliance on third parties, ensuring you receive the best possible
            rates and a smooth, uninterrupted travel experience from start to
            finish.
          </p>
